$(document).ready(function () {
  // Adds event listener for fetching translation when button is clicked
  $('INPUT#btn_translate').click(fetchTranslation);

  // Adds event listener for fetching translation when ENTER is pressed in the language code input field
